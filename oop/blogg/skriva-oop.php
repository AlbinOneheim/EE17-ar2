    ...
    <div class="kontainer">
        ...
        <nav>
            <ul class="nav nav-tabs">
                <li class="nav-item"><a class="nav-link" href="./lasa-oop.php">Läsa</a></li>
                <li class="nav-item"><a class="nav-link active" href="./skriva-oop.php">Skriva</a></li>
                <li class="nav-item"><a class="nav-link" href="./lista-oop.php">Admin</a></li>
            </ul>
        </nav>
        <main>
            <?php
            ...
            if ($rubrik && $inlägg) {
                ...
                echo "<p>$rubrik \n $inlägg</p>";
                if ($resultat) {
                    echo "<p class=\"alert alert-success\">Dit inlägg har sparats</p>";
                }
            }
